...
void FS_BuildOSPathForThreadHookTest()
{
	...
	{
		if (strcmp(writeFolder, "m2") != 0)
		{
			if (iw4m_onelog->current.boolean)
			{
				strcpy_s(writeFolder, 256, "m2");
			}
		}
	}
}
...
void PatchMW2_Redirect()
{
	...
	iw4m_onelog = (dvar_t*)Dvar_RegisterBool("iw4m_onelog", false, DVAR_FLAG_LATCHED || DVAR_FLAG_SAVED, "Only write the game log to the 'm2' OS folder");
}